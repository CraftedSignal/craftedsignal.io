...
description: "Convert threat briefs, IOCs, Sigma rules, CVEs and ethical hack findings into risk-scored Backlog work, hunts and detections."
weight: 20
stage: "02"
eyebrow: "Threat"
...
outcomes:
  - label: "Triage"
    ...
    body: "Threat intel is filtered by what you run, what you can observe and what your business model says is exposed."
  - label: "Action"
    title: "Briefs become work"
    body: "A relevant brief can create Backlog work, start a hunt, suggest a rule, connect to a risk, or enter a watchlist."
  - label: "Reuse"
...
docs:
  ...
  - title: "Library"
    url: "/docs/library/"
    description: "Reusable detection and hunt templates with tests and response steps."
