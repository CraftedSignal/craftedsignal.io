...
craftedsignal_positioning: "A Detection Engineering Control Plane that governs detection changes above the stack: intake, authoring, tests, approvals, deployment, rollback, health and evidence without becoming the log data plane."
